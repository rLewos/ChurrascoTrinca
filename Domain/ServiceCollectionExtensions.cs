...
namespace Domain
{
    ...
    public static class Data
    {
        public static List<Person> People => new List<Person>
        {
			...
			new Person { Id = "5aa2e677-3dee-4920-87ea-44ea3f3d18ac", Name = "Yukino", IsCoOwner = false },
			new Person { Id = "768093b2-290e-4ceb-aa6b-11b270706410", Name = "Arthur", IsCoOwner = false },
			new Person { Id = "87145b19-0369-4189-a6e0-d1d0bb304d1b", Name = "James", IsCoOwner = false },
		};
    }
}
